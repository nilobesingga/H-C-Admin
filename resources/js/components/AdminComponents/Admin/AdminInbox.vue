        ...
        <div v-if="filteredTodayNotifications.length > 0" class="mb-10">
            ...
            <div class="space-y-4">
                <div
                    ...
                    :key="`today-${index}`"
                    class="relative flex items-start p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 group"
                >
                    ...
                    <div class="flex flex-col items-end ml-4">
                        ...
                        <button
                            class="px-3 py-1 mt-2 text-xs font-medium text-blue-600 transition-opacity bg-white border border-blue-200 rounded-md opacity-0 group-hover:opacity-100 hover:bg-blue-50"
