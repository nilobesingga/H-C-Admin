<template>
    <div class="w-full min-h-screen p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-extrabold text-gray-900">Setup Request</h1>
        </div>
        ...
        <div class="w-full overflow-hidden bg-white border border-gray-300 rounded-lg shadow">
            ...
            <div class="grid grid-cols-12 px-6 py-4 text-sm font-medium text-gray-600 border-b border-gray-200 bg-gray-50">
                ...
                <div class="col-span-2">Time Frame</div>
            ...
            <div v-else-if="filteredRequests.length > 0">
                ...
                >
                    ...
                    <div class="col-span-2">{{ req.timeframe }}</div>
                    <div class="col-span-1 mx-2 capitalize text-nowrap">{{ req.contact_method }}</div>
                    <div class="col-span-1 mx-2 capitalize text-nowrap">{{ req.language }}</div>
