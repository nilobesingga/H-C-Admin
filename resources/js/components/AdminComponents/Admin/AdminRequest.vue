<template>
    <div class="w-full min-h-screen p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-extrabold text-gray-900">My Request</h1>
        </div>
        ...
        <div class="mb-6">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center">
                ...
                <div class="mb-4 md:mb-0">
                    <div class="inline-flex bg-gray-400 border border-gray-500 rounded-lg shadow-sm" role="group">
                        <button
                            ...
                            :class="[
                                ...
                                activeTab === tab.value
                                    ...
                                    : 'text-gray-700 hover:bg-gray-200 border-l border-gray-500',
                            ]"
                        >
                            {{ tab.label }}
                        </button>
        ...
        <div class="w-full overflow-hidden bg-white border border-gray-300 rounded-lg shadow">
            ...
            <div class="grid grid-cols-12 px-6 py-4 text-sm font-medium text-gray-600 border-b border-gray-200 bg-gray-50">
                ...
                <div class="col-span-2">Request No.</div>
            ...
            <div v-else-if="filteredRequests.length > 0">
                ...
                >
                    ...
                    <div class="col-span-2 font-medium">{{ req.request_no }}</div>
                    <div class="col-span-2">{{ req.description }}</div>
                    <div class="col-span-2 capitalize">{{ req.type }}</div>
                    ...
                    <div class="col-span-1">
                        <span
                            :class="[
                                ...
                                req.status === 'cancelled' ? 'bg-amber-100 text-amber-800' :
        ...
        <div
            ...
            class="fixed bottom-0 left-0 right-0 z-10 flex items-center justify-between p-4 bg-white border-t border-gray-200 shadow-lg"
        >
            <div class="text-sm text-gray-600">
                <span class="font-medium">{{ selectedRequests.length }}</span> {{ selectedRequests.length === 1 ? 'item' : 'items' }} selected
            </div>
            <div class="flex items-center space-x-3">
                <button class="px-4 py-2 text-gray-700 transition-colors bg-white border border-gray-300 rounded hover:bg-gray-50">
                    Export Selected
                </button>
                <button class="px-4 py-2 text-white transition-colors bg-red-600 rounded hover:bg-red-700">
                    Delete Selected
                </button>
            </div>        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                // Document and change request categories
                documentCategories: [
                    'Certified Documents',
                    'Notarised Documents',
                    'Apostilled Documents',
