                ...
                <table class="w-full c-table table table-border align-middle text-xs table-fixed">
                    <thead>
                        <tr class="bg-black text-gray-900 font-medium text-center">
                            ...
                            <th class="sticky top-0 w-[110px] text-right">Amount</th>
                            <th class="sticky top-0 w-[200px] text-left">Subject</th>
                            <th class="sticky top-0 w-[250px] text-left">CRM <i class="ki-outline ki-exit-down"></i></th>
                            <th class="sticky top-0 w-[100px]">Payment Terms</th>
                            <th class="sticky top-0 w-[120px]">Responsible Person</th>
                            <th class="sticky top-0 w-[110px]">Charge to Account</th>
                            <th class="sticky top-0 w-[80px]">Created On</th>
                        </tr>
                    </thead>
