                ...
                <div class="bg-white z-5 border rounded-md hover:border-black/20 ring-0 hover:ring-8 ring-white/70 transition-all duration-300 backdrop-blur shadow-sm hover:shadow-2xl hover:shadow-black/5 p-7 max-w-[500px] w-full">
                    <form action="{{ route('auth-login') }}" method="POST" role="form" class="flex flex-col gap-5 p-10 card-body" id="sign_in_form">
                        ...
                        <div class="mb-10 text-center">
                            ...
                            <span class="text-sm text-gray-700">Client Portal: Secure Access</span>
                        </div>
                        <div class="flex flex-col gap-1 mb-2">
                            <label class="block mb-1 text-sm font-medium" for="contact">Username</label>
                            <input name="login" type="text" class="input input-normal" placeholder="Username" autofocus />
                        </div>
                        <div class="flex flex-col gap-1 mb-2">
                            <label class="block mb-1 text-sm font-medium" for="contact">Password</label>
                            <div data-toggle-password="true">
                                <input name="password" type="password" class="input input-normal" placeholder="********"  required />
                                @if($errors->all())
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <label class="flex items-center space-x-2">
                                <input type="checkbox" name="remember" class="hidden peer" id="remember">
                        ...
                        <button type="submit" class="flex justify-center text-white main-btn text-md grow" style="background-color: #313d4f; color: #fff;">Sign in</button>
                    </form>
                </div>
            </div>
        </div>
