...
<html>
    ...
    <style>
        ...
        .seal-container {
            position: relative; /* Ensures the container can hold the absolute-positioned stamp */
            min-height: 160px; /* Ensures space for the stamp */
        }
        ...
        .seal-image {
            ...
            page-break-inside: avoid; /* Prevents stamp from breaking across pages */
        }
    </style>
    <body>
        <main>
            ...
            @if($directors && count($directors) > 0)
                <div class="container default-font break">
                    ...
                    <div style="position: relative; min-height: 100px;"> <!-- Ensures enough space for the stamp -->
                        <div style="position: absolute; bottom: 10px; right: 10px;">
                            @if(isset($sealImage) && $sealImage)
                                <img src="{{ $sealImage }}" style="width: 100px; height: 100px; opacity: 0.9;">
                            @endif
                        </div>
                    </div>
                </div>
