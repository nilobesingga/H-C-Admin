...
{{--                            Account--}}
{{--                            <span class="menu-arrow"><i class="ki-filled ki-down"></i></span>--}}
{{--                        </button>--}}
...
{{--                                    <span class="menu-icon"><i class="ki-filled ki-users"></i></span>--}}
...
{{--            <a class="btn btn-xs btn-primary mr-1 sm:mr-0" href="html/demo3/account/home/get-started.html">Get Started</a>--}}
...
{{--                                                        <span class="menu-icon"><i class="ki-filled ki-sms"></i></span>--}}
{{--                                                        <span class="menu-title">Email</span>--}}
{{--                                                    </a>--}}
{{--                                                </div>--}}
{{--                                                <div class="menu-item">--}}
{{--                                                    <a class="menu-link" href="html/demo3/account/home/settings-sidebar.html">--}}
{{--                                                        <span class="menu-icon"><i class="ki-filled ki-message-notify"></i></span>--}}
...
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-4.png"/>--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-5.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-3.5">--}}
...
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-27.png"/>--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-1.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
...
{{--                                                    <img class="h-5" metronic="assets/media/file-types/pdf.svg"/>--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-11.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-1">--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-14.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-3.5 grow">--}}
...
{{--                                                        <img class="h-5" metronic="assets/media/file-types/figma.svg"/>--}}
{{--                                                    </div>--}}
{{--                                                    <a class="hover:text-primary-active font-medium text-gray-700 text-xs me-1" href="#">--}}
{{--                                                        Launcher-UIkit.fig--}}
{{--                                                    </a>--}}
...
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-25.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-3.5 grow">--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-34.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-3.5 grow">--}}
...
{{--                                                    <div class="flex items-center gap-1.5">--}}
{{--                                                        <img class="h-6" metronic="assets/media/file-types/xls.svg"/>--}}
...
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-29.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
...
{{--                                                            <div class="flex">--}}
{{--                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" metronic="assets/media/avatars/300-3.png"/>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="flex">--}}
{{--                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" metronic="assets/media/avatars/300-2.png"/>--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5" id="notification_request_3">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-30.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-3.5">--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-24.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-1">--}}
...
{{--                                        <div class="flex grow gap-2 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-15.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
...
{{--                                                        <div class="flex -space-x-2">--}}
{{--                                                            <div class="flex">--}}
{{--                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" metronic="assets/media/avatars/300-4.png"/>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="flex">--}}
{{--                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" metronic="assets/media/avatars/300-1.png"/>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="flex">--}}
{{--                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" metronic="assets/media/avatars/300-2.png"/>--}}
{{--                                                            </div>--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-6.png"/>--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-12.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-3.5 grow">--}}
...
{{--                                                <div class="card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-light-active">--}}
{{--                                                    <div class="flex items-center gap-1.5">--}}
{{--                                                        <img class="h-6" metronic="assets/media/file-types/word.svg"/>--}}
{{--                                                        <div class="flex flex-col gap-0.5">--}}
{{--                                                            <a class="hover:text-primary-active font-medium text-gray-700 text-xs" href="#">--}}
{{--                                                                Landing-page.docx--}}
{{--                                                            </a>--}}
...
{{--                                                <div class="card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-light-active">--}}
{{--                                                    <div class="flex items-center gap-1.5">--}}
{{--                                                        <img class="h-6" metronic="assets/media/file-types/svg.svg"/>--}}
{{--                                                        <div class="flex flex-col gap-0.5">--}}
{{--                                                            <a class="hover:text-primary-active font-medium text-gray-700 text-xs" href="#">--}}
{{--                                                                New-icon.svg--}}
{{--                                                            </a>--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-21.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-3.5">--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5" id="notification_request_3">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-13.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-3.5">--}}
...
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-19.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-2.5 grow">--}}
...
{{--                                                        <img class="h-5" metronic="assets/media/brand-logos/jira.svg"/>--}}
{{--                                                    </div>--}}
{{--                                                    <a class="hover:text-primary-active font-medium text-gray-700 text-xs me-1" href="#">--}}
{{--                                                        User-feedback.jira--}}
{{--                                                    </a>--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-17.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-2.5 grow">--}}
...
{{--                                        <div class="flex grow gap-2.5 px-5">--}}
{{--                                            <div class="relative shrink-0 mt-0.5">--}}
{{--                                                <img alt="" class="rounded-full size-8" metronic="assets/media/avatars/300-9.png"/>--}}
{{--                                                <span class="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">--}}
{{--               </span>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex flex-col gap-2.5 grow">--}}
...
{{--                                            <img alt="" class="size-7" metronic="assets/media/brand-logos/gitlab.svg"/>--}}
{{--                                        </div>--}}
{{--                                        <div class="flex flex-col">--}}
...
{{--                                        <div class="flex -space-x-2">--}}
{{--                                            <div class="flex">--}}
{{--                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" metronic="assets/media/avatars/300-4.png"/>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex">--}}
{{--                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" metronic="assets/media/avatars/300-1.png"/>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex">--}}
{{--                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" metronic="assets/media/avatars/300-2.png"/>--}}
{{--                                            </div>--}}
{{--                                            <div class="flex">--}}
...
{{--                                    <img alt="" class="rounded-full size-9" metronic="assets/media/avatars/300-5.png"/>--}}
{{--                                    <div class="flex flex-col gap-1.5">--}}
...
{{--                                        <img alt="" class="rounded-full size-9" metronic="assets/media/avatars/300-2.png"/>--}}
{{--                                        <span class="size-[4.8px] badge badge-circle badge-success absolute top-7 end-0 transform -translate-y-1/2">--}}
{{--             </span>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="flex items-end gap-3.5 px-5">--}}
{{--                                    <img alt="" class="rounded-full size-9" metronic="assets/media/avatars/300-4.png"/>--}}
{{--                                    <div class="flex flex-col gap-1.5">--}}
{{--                                        <div class="card shadow-none flex flex-col bg-gray-100 gap-2.5 p-3 rounded-bl-none">--}}
{{--                                            <p class="text-2sm font-medium text-gray-700">--}}
...
{{--                                </div>--}}
{{--                                <div class="flex items-end gap-3.5 px-5">--}}
{{--                                    <img alt="" class="rounded-full size-9" metronic="assets/media/avatars/300-1.png"/>--}}
{{--                                    <div class="flex flex-col gap-1.5">--}}
{{--                                        <div class="card shadow-none flex flex-col bg-gray-100 gap-2.5 p-3 rounded-bl-none">--}}
{{--                                            <p class="text-2sm font-medium text-gray-700">--}}
...
{{--                                <img alt="" class="rounded-full size-[30px] absolute start-0 top-2/4 -translate-y-2/4 ms-2.5" metronic="assets/media/avatars/300-2.png"/>--}}
...
{{--                                        <img alt="" class="size-6" metronic="assets/media/brand-logos/jira.svg"/>--}}
{{--                                    </div>--}}
{{--                                    <div class="flex flex-col">--}}
{{--                                        <a class="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">--}}
{{--                                            Jira--}}
...
{{--                                <div class="flex items-center flex-wrap gap-2">--}}
{{--                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">--}}
{{--                                        <img alt="" class="size-6" metronic="assets/media/brand-logos/inferno.svg"/>--}}
{{--                                    </div>--}}
{{--                                    <div class="flex flex-col">--}}
{{--                                        <a class="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">--}}
{{--                                            Inferno--}}
...
{{--                                <div class="flex items-center flex-wrap gap-2">--}}
{{--                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">--}}
{{--                                        <img alt="" class="size-6" metronic="assets/media/brand-logos/evernote.svg"/>--}}
{{--                                    </div>--}}
{{--                                    <div class="flex flex-col">--}}
{{--                                        <a class="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">--}}
{{--                                            Evernote--}}
...
{{--                                <div class="flex items-center flex-wrap gap-2">--}}
{{--                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">--}}
{{--                                        <img alt="" class="size-6" metronic="assets/media/brand-logos/gitlab.svg"/>--}}
{{--                                    </div>--}}
{{--                                    <div class="flex flex-col">--}}
{{--                                        <a class="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">--}}
{{--                                            Gitlab--}}
...
{{--                                <div class="flex items-center flex-wrap gap-2">--}}
{{--                                    <div class="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">--}}
{{--                                        <img alt="" class="size-6" metronic="assets/media/brand-logos/google-webdev.svg"/>--}}
{{--                                    </div>--}}
{{--                                    <div class="flex flex-col">--}}
{{--                                        <a class="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">--}}
{{--                                            Google webdev--}}
