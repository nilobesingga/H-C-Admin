        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
            ...
            <a href="{{ route('admin.settings.modules') }}"
               class="card p-5 lg:p-7.5 lg:pt-7 flex flex-col gap-4 hover:bg-gray-100 transition-colors">
                ...
                <div class="flex flex-col gap-3">
                    <div class="text-base font-medium leading-none text-gray-900 hover:text-primary-active">Modules</div>
                </div>
            </a>
            <a href="{{ route('admin.settings.bitrix-sage-mapping') }}"
               class="card p-5 lg:p-7.5 lg:pt-7 flex flex-col gap-4 hover:bg-gray-100 transition-colors">
                ...
                <div class="flex flex-col gap-3">
                    <div class="text-base font-medium leading-none text-gray-900 hover:text-primary-active">Bitrix Sage Mapping</div>
                </div>
            </a>
        </div>
    </div>
